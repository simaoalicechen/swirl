...
| Thanks, Alice. Let's cover a couple of quick housekeeping items before we
...
> my_sqrt<-(z-1)2
Error: unexpected numeric constant in "my_sqrt<-(z-1)2"
> my_sqrt<-sqrt(z-1)
...
What is your assignment token? RHCV8R6AUCv1xhj7
