...
Error in xy.coords(x, y, xlabel, ylabel, log) : 
  'x' and 'y' lengths differ
> plat(x=car$speed, y=car$dis)
Error in plat(x = car$speed, y = car$dis) : 
  could not find function "plat"
> plot(x=car$speed, y=car$dist)
Error in plot(x = car$speed, y = car$dist) : object 'car' not found
...
> ?boxplot9
No documentation for ‘boxplot9’ in specified packages and libraries:
you could try ‘??boxplot9’

| Keep trying! Or, type info() for more options.

| Type ?boxplot or help(boxplot) to view a help page with details about
| boxplot.
...
What is your assignment token? XcidfPeODcTin1KL
